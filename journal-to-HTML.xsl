            ...
            <body>
                ...
                <div class="navigation">
                    <table class="navigation">
                        <tr>
                            <td class="home"><div class="navLink"><a href="index.html">Home</a></div></td>
                            <td><div class="dropdown">
                                <button class="dropbtn">The Dissertation</button>
                                <div class="dropdown-content">
                                    <a href="gde-dissertationrationalepage.html">Dissertation Rationale</a>
                                    <a href="gde-digitaldissertationpage.html">Read the Dissertation Chapter</a>
                                    <a href="abouteditorpage.html">About the Editor</a>
                                </div>
                ...
                </div><a href="index.html"><img class="header" id="headerimage" width="1920" height="256"
                    src="images/GDE-JournalHeaderRevised.jpg"
                    alt="The Elizabeth Gaskell Journal Header Image"/></a><div class="block"></div>
