    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <div id="fieldset">
                    <fieldset><legend><span class="dipNorm">Edition View: The default view of the
                                ...
                                Gaskell's own spellings and symbols.<br/> Click to choose the
                                Normalized view</span><span class="dipNormSmall"> (shows
                                conventional spellings; hides notes, insertion marks, and
                                deletions):</span></legend><span class="choose"><input type="checkbox" id="REGtoggle"
                                    style="cursor:pointer"/><label for="REGtoggle">Select normalized view.</label></span></fieldset>
                </div>
